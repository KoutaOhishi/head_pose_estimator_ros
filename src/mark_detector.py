...
class FaceDetector:
    ...
    #def __init__(self, dnn_proto_text='assets/deploy.prototxt',dnn_model='assets/res10_300x300_ssd_iter_140000.caffemodel'):
    def __init__(self):
        """Initialization"""
        print "TensorFlow version: %s".format(tf.__version__)
        package_path = roslib.packages.get_pkg_dir("head_pose_estimator")
        dnn_proto_text = package_path + "/model/deploy.prototxt"
        dnn_model = package_path + "/model/res10_300x300_ssd_iter_140000.caffemodel"
...
class MarkDetector:
    ...
    def __init__(self):
        """Initialization"""
        package_path = roslib.packages.get_pkg_dir("head_pose_estimator")
        saved_model = package_path + "/model/tmp"
